package com.example.picker_selector_app.common
...
class PermissionManager private constructor(private val fragment: WeakReference<Fragment>) {
    ...
    private fun displayRationale(fragment: Fragment) {
        AlertDialog.Builder(fragment.requireContext())
            .setTitle(fragment.getString(R.string.permissionRequiredLabel))
            .setMessage(rationale ?: fragment.getString(R.string.defaultMessageLabel))
            .setCancelable(false)
            .setPositiveButton(fragment.getString(R.string.okLabel)) { _, _ ->
                requestPermissions()
            }
            .show()
    }
